    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Mettre à jour un personnel</h1>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">Gestion Personnels</a>
                        </li>
            ...
            <div class="table-data">
                <div class="order">
                    <div class="head">
                        <h3>Mettre à jour un personnel</h3>
                    </div>
                    <?php
                        ...
                        <div class="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="pays" name="pays" value="<?php echo $personnel['pays']; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
